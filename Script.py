class script(object):
    START_TXT = """<b><u>𝙳𝚛𝚊𝚐𝚘𝚗 𝙵𝚒𝚛𝚎 𝙿𝚛𝚒𝚖𝚎</u></b>
...
"""
    ...
    GSTART_TXT = """<b>𝙳𝚛𝚊𝚐𝚘𝚗 𝙵𝚒𝚛𝚎 𝙿𝚛𝚒𝚖𝚎</b>
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b><a href="https://telegram.me/Requiest_your_faw">{file_name}</a>➥𝐃𝐫𝐚𝐠𝐨𝐧 𝐏𝐫𝐢𝐦𝐞 🐉</b>\n\n<b>⚜️ Powered By : <a href="https://t.me/+A_p2XwI6s0A5MDY1">[ @MagicOfGroup ]</a></b>"""
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @DragonAdminCantact_bot
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/DragonAdminCantact_bot'>Owner</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
‼️ ᴍᴜsᴛ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴀғᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ.</b>"""
    ...
    SOURCE_TXT ="""<b>𝚂𝚘𝚞𝚛𝚌𝚎 𝙲𝚘𝚍𝚎 : 👇 </b>

This Is The Source Code.\n
ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<a href=https://t.me/DragonAdminCantact_bot>𝐃𝐫𝐚𝐠𝐨𝐧 𝐏𝐫𝐢𝐦𝐞</a>\n """
